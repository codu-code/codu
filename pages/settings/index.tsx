    ...
    <Layout>
      <>
        <div className="bg-white text-gray-800">
          <form
            className="mx-auto lg:col-span-9 max-w-5xl flex-grow flex flex-col justify-center w-full px-4 sm:px-6"
            action="#"
            method="POST"
          >
            {/* Profile section */}
              ...
              <div>
                ...
                <div className="pt-6 divide-y divide-gray-200">
                  ...
                  <div className="mt-4 py-4 flex justify-end">
                    <button
                      type="button"
                      className="bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-300"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="ml-5 w-20 bg-gradient-to-r from-orange-400 to-pink-600 rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:from-orange-300 hover:to-pink-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-300"
                    >
                      Save
                    </button>
                  </div>
