      ...
      <div className="fixed bottom-0 z-20 w-full border-t border-neutral-700 bg-white py-2 dark:bg-neutral-900 lg:top-1/2 lg:h-56 lg:w-20 lg:-translate-y-1/2 lg:border-b lg:border-r lg:px-2">
        <div className="flex h-full justify-evenly lg:flex-col">
          ...
          <Popover className="relative ml-4">
            <Popover.Button className="rounded-full p-1 hover:bg-neutral-300 dark:hover:bg-neutral-800">
            ...
            >
              <Popover.Panel className="absolute bottom-14 right-0 mt-2 w-48 origin-top-right rounded-md bg-white px-1 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-white lg:bottom-0 lg:left-16">
                <div>
                  <ul>
