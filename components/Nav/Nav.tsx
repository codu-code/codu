								...
								<div className="flex-shrink-0">
									...
									<Link href="/">
										<a className="hidden lg:block h-8 w-auto">
											<Image src="/images/codu.png" alt="Codú logo" height={30} width={94.5} priority={true} />{" "}
										...
										{navigation.map((item) =>
											item.href.includes("http") ? (
												...
												<Link key={item.name} href={item.href}>
													<a className="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md">{item.name}</a>
												</Link>
											)
										)}
									</div>
							...
							<div className="hidden md:ml-6 md:block">
								<div className="flex items-center text-sm lg:text-base font-medium">
									{session ? (
										<>
											<Link href="/my-posts">
												<a className="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md">Your Posts</a>
											</Link>
											<Link href="/create">
										...
										<>
											<Link href="/get-started">
												<a className="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md">Sign in</a>
											</Link>
											<Link href="/get-started">
												...
												<Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 px-1 ring-black ring-opacity-5 focus:outline-none">
													{userNavigation.map((item) => (
														<Menu.Item key={item.name}>
															{item.onClick ? (
																<button
																	className={"flex text-left w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded"}
																...
																<Link href={item.href || ""}>
																	<a className={"block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded"}>{item.name}</a>
																</Link>
															)}
														</Menu.Item>
													))}
