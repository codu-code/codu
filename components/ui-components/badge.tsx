...
const colors = {
  ...
  orange:
    "bg-accent/15 text-accent group-data-[hover]:bg-accent/25 dark:bg-accent/10 dark:text-accent dark:group-data-[hover]:bg-accent/20",
  amber:
  ...
  pink: "bg-accent/15 text-accent group-data-[hover]:bg-accent/25 dark:bg-accent/10 dark:text-accent dark:group-data-[hover]:bg-accent/20",
