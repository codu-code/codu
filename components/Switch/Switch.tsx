...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    ref={ref}
  >
    <SwitchPrimitives.Thumb className="pointer-events-none ml-[2px] block h-5 w-5 rounded-full bg-black shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 dark:bg-white" />
  </SwitchPrimitives.Root>
));
